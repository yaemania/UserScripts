...
// @twitter https:/tiadbkiller
// @updateURL https://raw.githubck-killer.user.js
// @downloadURL https://ler.user.js
// @supportURL https://githubller/issues
// @contributionURL https://githuller#donate
...
Aak = {
  ...
  version : '7.8',
  scriptid : 'gJWEp0vB',
  homeURL : 'https://github.ller--reek',
  changelogURL : 'httpchangelog',
  donateURL : 'https://githuate',
  featuresURL : 'https://githller#features',
  reportURL : 'https://gitt-Guide',
  twitterURL : 'https://twkiller',
  downloadURL : 'https://k-killer.user.js',
